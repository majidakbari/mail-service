...
return [
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'majid@akbari.com'),
    ...
    */
    ...
    'providers' => [
        [
            ...
            'port' => env('SENDGRID_PORT', 465),
            'encryption' => env('SENDGRID_ENCRYPTION', 'ssl'),
        ...
        [
            ...
            'port' => env('MAILJET_PORT', 465),
            'encryption' => env('MAILJET_ENCRYPTION', 'ssl'),
